/**
 * @FileName  : PPGatewayRegistrationJsonParser.java
 ...
 */
public class PPGatewayRegistrationJsonParser implements PPBaseJsonParser {
	...
	public boolean setData(JSONObject jso, Object[] obj) {
		try 
        {
			...
			DeviceModel.sDeviceType  = (jso.containsKey("deviceType")) ? jso.getString("deviceType") : null;
